...
FIG_LABEL = "GRU With 8 hidden layers"
FIGS_PATH = "./gru-8fc/"
...
learning_rate = 0.005
num_epochs = 30 # number of iterations in the training loop
...
class RNN(nn.Module):
    ...
    def __init__(self, input_features, hidden_features_layer1, num_layers, num_of_classes):
        ...
        self.fc1 = nn.Linear(hidden_features_layer1, hidden_features_layer2)
        self.fc2 = nn.Linear(hidden_features_layer2, hidden_features_layer2)
        self.fc3 = nn.Linear(hidden_features_layer2, hidden_features_layer2)
        self.fc4 = nn.Linear(hidden_features_layer2, hidden_features_layer2)
        self.fc5 = nn.Linear(hidden_features_layer2, hidden_features_layer2)
        self.fc6 = nn.Linear(hidden_features_layer2, hidden_features_layer2)
        self.fc7 = nn.Linear(hidden_features_layer2, hidden_features_layer2)
        self.fc8 = nn.Linear(hidden_features_layer2, num_of_classes, bias=False)
...
#plt.show()
#save figure:
plt.savefig(f"./{FIGS_PATH}/RNN2hiddenlayers40ep256weights.svg")
plt.savefig(f"./{FIGS_PATH}/RNN2hiddenlayers40ep256weights.pdf")
